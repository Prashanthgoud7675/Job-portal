...
<body>
    ...
    <div class="main_container" style="position:inherit">
...
@endforeach
<br><br><br><br>
<button  type="button" class="btn btn-primary active" data-bs-toggle="modal" data-bs-target="#exampleModal" style="height:50px;width:250px;color:black;margin-left:5%"><a href="project">
  Add project
 </a></button>
...
<div class="card" style="width:80rem; background-color:whitesmoke;">
